...
static volatile uint8 LCD_InitState    = ONE;
static volatile uint8 SendCommadFinish = ZERO ;
...
static void LCD_displayCharSection1 (uint8 LCD_Char);
static void LCD_displayCharSection2 (uint8 LCD_Char);
...
void LCD_sendCommand (uint8 LCD_Command){
    static uint8 SendCommandState = ONE ;
...
static void LCD_initSection1(void)
{
    static  uint8 Section1State  = ONE;
